...
function getPrisons() {
    ...
    $.ajax({
        ...
        error: function () {
            alert('Something is wrong, couldn\'t get prisons');
        },
        success: function (resp) {
            if (resp) {
                resp = JSON.parse(resp)

                displayPrisonsItems(resp);
                // displayMenuButtons();
            }
...
function displayPrisonsItems(prisonsItems) {
    let displayPrisons = prisonsItems.map(function (item) {
    ...
    displayPrisons = displayPrisons.join("");
    sectionCenter.innerHTML = displayPrisons;
}

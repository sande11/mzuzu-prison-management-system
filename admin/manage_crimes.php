...
<body>
    ...
    <script>
    $('#save_crime').submit(function(e) {
        e.preventDefault()
        $.ajax({
            url: '../ajax.php?action=save_crime',
            method: 'POST',
            data: $(this).serialize(),
            success: function(resp) {
                if (resp) {
                    resp = JSON.parse(resp)
                    window.location.href = 'manage_crimes.php';
                }
            },
            complete: function() {}
        })
    ...
    <script src="js/crimes.js"></script>
</body>
